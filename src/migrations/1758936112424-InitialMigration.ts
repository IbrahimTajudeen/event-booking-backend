...
export class InitialMigration1758936112424 implements MigrationInterface {
    name = 'InitialMigration1758936112424'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "payments" ("id" SERIAL NOT NULL, "amount" numeric(10,2) NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', "paidAt" TIMESTAMP NOT NULL DEFAULT now(), "bookingId" integer, CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
